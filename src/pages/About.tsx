...
export function About() {
    return (
        <div style={{
            ...
            >
                About Padel <span style={{ color: 'var(--color-primary)' }}>Park</span>
            </motion.h1>
            ...
            >
                <p style={{ marginBottom: '1.5rem' }}>
                    Born from a passion for the world's fastest-growing sport, Padel Park is more than just a place to play—it's a community hub.
                </p>
                <p style={{ marginBottom: '1.5rem' }}>
